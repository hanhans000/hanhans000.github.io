...
document.getElementById("share-facebook").addEventListener("click", () => {
  window.open(
    "https://www.facebook.com/sharer/sharer.php?u=https://yourwebsite.com"
  );
});
...
darkModeToggle.addEventListener("click", () => {
  if (body.style.backgroundColor === "var(--dark-mode-bg)") {
    body.style.backgroundColor = "var(--primary-bg-color)";
    body.style.color = "var(--text-color)";
  } else {
    body.style.backgroundColor = "var(--dark-mode-bg)";
    body.style.color = "var(--dark-mode-text)";
  }
});
